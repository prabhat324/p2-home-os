...
SUDOERS_FILE="/etc/sudoers.d/p2ops-p2-dashboard-route"
...
p2ops ALL=(root) NOPASSWD: /usr/local/sbin/p2ops-p2-dashboard-route status
p2ops ALL=(root) NOPASSWD: /usr/local/sbin/p2ops-p2-dashboard-route activate-custom
p2ops ALL=(root) NOPASSWD: /usr/local/sbin/p2ops-p2-dashboard-route restore-homepage
EOF
sudo visudo -cf "$TMP"
...
echo "p2ops still has no general sudo, Docker, shell, or arbitrary Caddy access."
